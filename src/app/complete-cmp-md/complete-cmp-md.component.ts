...
const COMPLETER_CONTROL_VALUE_ACCESSOR = {
    ...
    useExisting: forwardRef(() => CompleteCmpMd),
    multi: true
};

@Component({
    selector: "ng2Complete-md",
    templateUrl: "./complete-cmp-md.component.html",
    styleUrls: ["./complete-cmp-md.component.css"],
    providers: [COMPLETER_CONTROL_VALUE_ACCESSOR]
})
export class CompleteCmpMd implements OnInit, ControlValueAccessor {
